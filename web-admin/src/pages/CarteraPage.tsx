          ...
          <div className="space-y-3">
            ...
            {result?.whatsappUrl ? (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 w-full py-2.5 rounded-lg bg-brand-whatsapp/10 hover:bg-brand-whatsapp/20 border border-brand-whatsapp/30 text-brand-whatsapp text-[12px] font-semibold transition-colors"
              >
                <WhatsAppIcon />
                Enviar por WhatsApp
                {result.ownerPhone && (
                  <span className="text-brand-whatsapp/70 font-normal">{result.ownerPhone}</span>
                )}
              </a>
            ) : (
          ...
          {withPhone.map((r) => {
            ...
            return (
              <div key={r.chargeId}
                ...
                {isSent ? (
                  <span className="flex items-center gap-1 text-brand-whatsapp text-[11px] font-semibold flex-shrink-0">
                    <CheckIcon />
                    Enviado
                  </span>
                ) : (
